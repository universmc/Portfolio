...
const imagePrompts = {
  ...
  'prototype': "An interactive and dynamic simulation of a website's user interface, demonstrating functionality, transitions, and animations, emphasizing the overall user experience and interactivity."
};
