...
const imagePrompts = {
  ...
  'prototype': "un site Web interactif dédié à la machine Learning aux intelligences artificielles. La page doit être claire sur un ton sombre et purée en vue d'un public professionnel, L'image doit contenir le menu de navigation, le contenu principal, développement de la présentation de l'intelligence artificielle et un pied de page nous indiquant les liens et routage du Web site."
};
...
<head>
    ...
    <title>${title}</title>
        ...
        <link rel="stylesheet" href="src/css/bannier.css">
</head>
<body>
  <header>
...
<div class="description">
    ...
    <script src="src/js/bannier.js"></script>
